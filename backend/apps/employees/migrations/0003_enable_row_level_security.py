"""Postgres RLS as defense-in-depth for every tenant-scoped table in this
app — see apps/subscriptions/migrations/0002_enable_row_level_security.py
for the full rationale and apps/audit_logs/migrations/0002_enable_row_level_security.py
...
TABLES = ["employees_department", "employees_employee", "employees_managerassignment"]
...
class Migration(migrations.Migration):
    dependencies = [("employees", "0002_initial")]
